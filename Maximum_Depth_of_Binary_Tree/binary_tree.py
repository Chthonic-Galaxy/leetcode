...
if __name__ == "__main__":
    ...
    print(f"Tree root 1: {tree1.val}")
    print(f"Left root child 1: {tree1.left}")
    print(f"Right root child 1: {tree1.right.val}")
    print(f"Left node child 2: {tree1.right.left.val}")
    print(f"Right node child 2: {tree1.right.right}")
